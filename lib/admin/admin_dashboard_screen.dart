...
import 'package:passage/admin/admin_products_tab.dart';
                ...
                child: ListTile(
                  ...
                  trailing: PopupMenuButton<String>(
                    ...
                    itemBuilder: (context) => const [
                      PopupMenuItem(value: 'details', child: ListTile(leading: Icon(Icons.info_outline), title: Text('Details'))),
                      PopupMenuDivider(),
                      PopupMenuItem(value: 'processing', child: ListTile(leading: Icon(Icons.timelapse), title: Text('Set Processing'))),
                      PopupMenuItem(value: 'shipped', child: ListTile(leading: Icon(Icons.local_shipping_outlined), title: Text('Set Shipped'))),
                      PopupMenuItem(value: 'delivered', child: ListTile(leading: Icon(Icons.check_circle_outline), title: Text('Set Delivered'))),
                      PopupMenuItem(value: 'cancelled', child: ListTile(leading: Icon(Icons.cancel_outlined), title: Text('Set Cancelled'))),
                      PopupMenuDivider(),
