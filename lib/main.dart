...
import 'package:passage/seller/seller_signup_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // Seller login maps to the same unified login screen
        '/seller/login': (_) => const LoginScreen(),
